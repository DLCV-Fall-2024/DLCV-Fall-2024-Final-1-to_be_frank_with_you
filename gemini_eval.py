...
def arguments():
    ...
    parser.add_argument("--api_key", type=int, default=DEFAULT_APIKEY_INDEX)
...
if __name__ == "__main__":
    ...
    # Load model
    genai.configure(api_key=keyset[args.api_key])
    ...
    for data in tqdm(reference):
        ...
        try:
            ...
            print("Error for sample: ", sample_id, ", Error: ", e)
            fail_cases.append(sample_id)
